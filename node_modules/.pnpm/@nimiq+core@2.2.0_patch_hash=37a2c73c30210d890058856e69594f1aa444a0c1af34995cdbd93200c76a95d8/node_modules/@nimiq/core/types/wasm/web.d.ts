...
export interface InitOutput {
  ...
  readonly transaction_sign: (a: number, b: number) => [number, number];
  ...
  readonly transactionbuilder_newCreateStaker: (a: number, b: number, c: bigint, d: number, e: bigint, f: number, g: number) => [number, number, number];
  ...
  readonly transactionbuilder_newUpdateStaker: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number) => [number, number, number];
  ...
  readonly closure1780_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2314_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__ha2bc1ea94075baaf: (a: number, b: number) => void;
  readonly closure2668_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure793_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure794_externref_shim: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h8c32cda5bcc26c90: (a: number, b: number) => void;
  readonly closure2882_externref_shim: (a: number, b: number, c: any, d: any) => void;
